...
class PhpAnalysis
{
    ...
    {
        $this->addonDicFile = PEP_PATH.'/public/lib/packages/wordanalysis/'.$this->addonDicFile;
        $this->mainDicFile  = PEP_PATH.'/public/lib/packages/wordanalysis/'.$this->mainDicFile;
