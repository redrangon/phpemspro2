...
require_once PEP_PATH."/public/lib/packages/wechat/WxPay.Config.Interface.php";
require_once PEP_PATH."/public/lib/packages/wechat/WxPay.Config.php";
require_once PEP_PATH."/public/lib/packages/wechat/WxPay.Exception.php";
require_once PEP_PATH."/public/lib/packages/wechat/WxPay.Data.php";
require_once PEP_PATH."/public/lib/packages/wechat/WxPay.Api.php";
require_once PEP_PATH."/public/lib/packages/wechat/WxPay.Notify.php";
require_once PEP_PATH."/public/lib/packages/wechat/WxPay.JsApiPay.php";
...
class wxpay extends \WxPayNotify
{
    ...
    public function NotifyProcess($objData,$config,&$msg)
    {
        ...
        {
            orders::payforOrder($order['ordersn'],'wxpay');
        }
        return true;
    }
    ...
    {
        $tools = new \JsApiPay();
        return $tools->GetUserInfoByToken($this->wxdata['openid'],$this->wxdata['access_token']);
    }
