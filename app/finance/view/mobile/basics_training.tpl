            ...
            <div class="pages-box nopadding">
                <div class="page-ele">
                    <ul class="listmenu">
                        ...
                        <li><a href="index.php?finance-mobile-basics-package&search[trid]={x2;v:training['trid']}" class="ajax">{x2;v:training['trname']} <i class="fa fa-menu-right pull-right"></i></a></li>
                        {x2;endtree}
                    </ul>
                </div>
            </div>
