...
{x2;endif}
    <form action="index.php?finance-mobile-basics-openbasic" method="post">
        ...
        <div class="pages-tabs">
            ...
            <div class="pages-content" data-pageurl="index.php?finance-mobile-basics-basics&search[trid]={x2;$search['trid']}" data-scroll="yes">
                <div class="pages-box">
                    {x2;endif}
                    {x2;tree:$basics['data'],basic,bid}
                    {x2;if:v:basic['prices']}
                    <div class="page-ele contin">
                        <h4 class="bigtitle">{x2;v:basic['stitle']}</h4>
                    </div>
                    <div class="page-ele contin clear">
                        {x2;tree:v:basic['prices'],price,pid}
                        <label class="cartbox margin mg1">
                            <input class="packageradio" id="packageradio_{x2;v:basic['sid']}_{x2;v:key}" type="checkbox" name="basics[{x2;v:basic['sdb']}][{x2;v:basic['sbasicid']}][{x2;v:key}]" value="{x2;v:key}" data-price="{x2;v:price['agentprice']}">
                            <div class="cart">
                                <div class="col-xs-8">
