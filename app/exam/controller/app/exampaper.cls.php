...
class exampaper extends app
{
    ...
    public function recover()
    {
        ...
        if($examsession)
        {
            ...
            $message = array(
                ...
                'message' => '恢复成功！',
                "callbackType" => "forward",
                "forwardUrl" => "index.php?exam-app-exampaper-paper&token={$token}&sign={$sign}"
            );
            \PHPEMSPRO\route::urlJump($message);
        }
        else
    ...
    public function paper()
    {
        ...
        if($this->basic['basicexam']['autotemplate'])
        \PHPEMSPRO\tpl::getInstance()->display($this->basic['basicexam']['autotemplate']);
        else
