...
class points
{
    ...
    static function getSubjectsList($args,$page,$number = \PHPEMSPRO\config::webpagenumber,$orderby = 'subjectid desc')
    {
        $data = array(
            'table' => 'subjects',
            'query' => $args,
    ...
    static function getSectionsList($args,$page,$number = \PHPEMSPRO\config::webpagenumber,$orderby = 'sectionorder desc,sectionid desc')
    {
        $data = array(
            'table' => 'sections',
            'query' => $args,
    ...
    static function getPointsList($args,$page,$number = \PHPEMSPRO\config::webpagenumber,$orderby = 'pointorder desc,pointid desc')
    {
        $data = array(
            'table' => 'points',
            'query' => $args,
