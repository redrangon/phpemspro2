		...
		<div class="pep nav">
			...
			<div class="col-xs-6">
				<ul class="list-unstyled list-inline pull-right">
                    <li class="title"><a><span id="timer_h">00</span>：<span id="timer_m">00</span>：<span id="timer_s">00</span></a></li>
                    <li class="title" style="padding-right: 0px;">
                        <button type="button" class="btn btn-warning actsaveanswer" style="margin: 10px 0px 10px 10px;"><i class="glyphicon glyphicon-save"></i> 保存答案</button>
                    </li>
                    <li class="title" style="padding-right: 0px;">
						<button type="button" onclick="javascript:$('#submodal').modal();" class="btn btn-primary" style="margin: 10px 0px 10px 10px;"><i class="glyphicon glyphicon-print"></i> 交卷</button>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="row-fluid panels">
		<div class="pep panels">
			<div class="col-xs-3" style="padding-left: 0px;">
				<ul class="leftmenu list-unstyled" style="overflow: hidden;margin-bottom: 10px;">
                    <li class="col-xs-6 text-center" style="padding: 10px;width: 42%;">
                        <img src="{x2;$_user['userphoto']}" width="120" height="144"/>
                    </li>
                    <li class="col-xs-6" style="width: 58%;">
                        <ul class="list-unstyled" style="padding: 10px 0px;">
                            <li>{x2;$_user['username']}</li>
                            <li>{x2;$_user['userrealname']}</li>
                        </ul>
                    </li>
                </ul>
				<div class="leftmenu swiper-container" style="background: none;overflow: hidden;" id="questionindex">
					<div class="swiper-wrapper" style="height: auto;">
						...
						<div class="swiper-slide questionindex">
                            ...
                            {x2;eval:v:qtid++}
                            {x2;eval:v:qtindex++}
							<a id="sign_{x2;v:question['questionid']}" data-index="{x2;v:qtid}" rel="{x2;v:question['questionid']}" href="javascript:;" class="questionindexbutton btn btn-default" ds="{x2;$useranswer[v:question['questionid']]}">{x2;v:qid}</a>
...
<script>
    $(function () {
        ...
        $.get('index.php?exam-app-exam-lefttime&token={x2;$token}&rand'+Math.random(),function(data){
            var setting = {
                time:{x2;$paper['time']},
                hbox:$("#timer_h"),
                mbox:$("#timer_m"),
        ...
        $('.actsaveanswer').on('click',function(){
            var that = $(this);
            saveanswer();
            that.html('<i class="glyphicon glyphicon-save"></i> 答案已存');
            setTimeout(function(){
                that.html('<i class="glyphicon glyphicon-save"></i> 保存答案');
            },3000);
        });
