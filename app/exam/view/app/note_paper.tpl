                ...
                <div class="leftmenu swiper-container" style="background: none;overflow: hidden;">
                    <div class="swiper-wrapper" style="height: auto;">
                        <div class="swiper-slide questionindex">
                            ...
                            <a href="index.php?exam-app-favor-notepaper&questype={x2;$questype}&pointid={x2;$point['pointid']}&number={x2;v:qid}" class="btn{x2;if:v:qid == $number} btn-primary{x2;else}{x2;if:$useranswer[v:question['questionid']]}{x2;if:$useranswer[v:question['questionid']]['status'] == 'right'} btn-success{x2;else} btn-danger{x2;endif}{x2;else} btn-default{x2;endif}{x2;endif}">{x2;v:qid}</a>
...
<script>
    function prepage(){
        {x2;if:$number > 1}
        window.location = 'index.php?exam-app-favor-notepaper&questype={x2;$questype}&pointid={x2;$point['pointid']}&number={x2;eval: echo $number - 1}';
        {x2;endif}
    }
