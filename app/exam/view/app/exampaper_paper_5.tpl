...
<head>
	<meta charset="UTF-8">
	<title>安全资格学习平台 (kv.9kpp.com)</title>
	<meta name="viewport" content="user-scalable=no">
	<meta name="mobile-web-app-capable" content="yes">
	<link rel="icon" href="favicon.ico" type="image/x-icon">
	<link rel="stylesheet" type="text/css" href="https://kv.9kpp.com/public/static/css/swiper.min.css" />
	<link rel="stylesheet" type="text/css" href="https://kv.9kpp.com/public/static/css/bootstrap.css" />
	<link rel="stylesheet/less" type="text/css" href="https://kv.9kpp.com/public/static/css/pep_app.less" />
	<script src="https://kv.9kpp.com/public/static/js/less.min.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/jquery.min.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/jquery.json.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/bootstrap.min.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/swiper.jquery.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/ckeditor/js/MathJax.js?config=TeX-AMS_HTML"></script>
	<script src="https://kv.9kpp.com/public/static/js/ckeditor/ckeditor.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/pep.app.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/md5-min.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/echarts.min.js"></script>
	<script src="https://kv.9kpp.com/public/static/js/vue.min.js"></script>
</head>
<style>
	.content-box {
...
<script>
	$(function(){
		setTimeout(function(){
			try{
				...
				for(k in initData){
					var v = initData[k];
					$('#time_'+k).val(v['time']);
					$("#paper :radio[rel="+k+"]").each(function(){
						var that = $(this);
						if(v['value'] == that.val()){
					...
					$("#paper :text[rel="+k+"],#paper textarea[rel="+k+"]").each(function(){
						...
						{
							that.parents(".qq-uploader-selector:first").find("a.btn").addClass("btn-primary").attr("href",v['value']).html("已上传");
						}
					});
        ...
        $('.nodonumber').html($('#questionindex .qindex').length - $('#questionindex .qindex.btn-primary').length);
