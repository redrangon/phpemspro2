                ...
                <div class="leftmenu swiper-container" style="background: none;overflow: hidden;">
                    <div class="swiper-wrapper" style="height: auto;">
                        <div class="swiper-slide questionindex">
                            ...
                            <a href="index.php?exam-app-favor-wrongpaper&questype={x2;$questype}&pointid={x2;$point['pointid']}&number={x2;v:qid}" class="btn{x2;if:v:qid == $number} btn-primary{x2;else}{x2;if:$useranswer[v:question['questionid']]}{x2;if:$useranswer[v:question['questionid']]['status'] == 'right'} btn-success{x2;else} btn-danger{x2;endif}{x2;else} btn-default{x2;endif}{x2;endif}">{x2;v:qid}</a>
            ...
            <div class="col-xs-9 nopadding">
                ...
                <div class="panel panel-default pagebox border" style="background: none;">
                    <div class="panel-heading blod" style="background: none;">
                        ...
                        <a data-toggle="tooltip" data-placement="bottom" title="也可以使用键盘右方向键切换" class="btn btn-default pull-right" onclick="javascirpt:nextpage();"> 下一题 <i class="glyphicon glyphicon-chevron-right"></i></a>
                        {x2;endif}
                        {x2;if:$number >1}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-body" id="selectbox"{x2;if:$useranswer[$question['questionid']]} data-useranswer="{x2;$useranswer[$question['questionid']]['answer']}"{x2;endif}{x2;if:$questypes[$question['questiontype']]['questsort']} data-answer="A"{x2;else} data-answer="{x2;$question['questionanswer']}"{x2;endif}>
...
<script>
    function prepage(){
        {x2;if:$number > 1}
        window.location = 'index.php?exam-app-favor-wrongpaper&questype={x2;$questype}&pointid={x2;$point['pointid']}&number={x2;eval: echo $number - 1}';
        {x2;endif}
    }
