...
<div class="container-fluid pages-header">
    ...
    <div class="row-fluid nav">
        <div class="pep nav">
            ...
            <div class="col-xs-6">
                <ul class="list-unstyled list-inline">
                    <li class="title">{x2;$basic['basic']}</li>
    ...
    <div class="row-fluid panels">
        <div class="pep panels">
            <div class="col-xs-3" style="padding-left: 0px;">
                <div class="leftmenu" style="border-bottom: 0px;">
                    <div class="topbox">
                        答题卡
                    </div>
                </div>
                <div class="leftmenu swiper-container" style="background: none;overflow: hidden;">
                    <div class="swiper-wrapper" style="height: auto;">
                        <div class="swiper-slide questionindex">
                            ...
                            <a href="index.php?exam-app-point&questype={x2;$questype}&pointid={x2;$point['pointid']}&number={x2;v:qid}" class="btn{x2;if:v:qid == $number} btn-primary{x2;else}{x2;if:$useranswer[v:question['questionid']]}{x2;if:$useranswer[v:question['questionid']]['status'] == 'right'} btn-success{x2;else} btn-danger{x2;endif}{x2;else} btn-default{x2;endif}{x2;endif}">{x2;v:qid}</a>
            ...
            <div class="col-xs-9 nopadding">
                <div class="pagebox hide" style="background: none;border: 0px;margin-bottom: 15px;">
                    <a class="btn{x2;if:$questype} btn-default{x2;else} btn-primary{x2;endif}" href="index.php?exam-app-point&pointid={x2;$point['pointid']}">不限题型</a>
                    {x2;tree:$subject['subjectsetting'],questype,qtid}
                    <a class="btn{x2;if:$questype == v:questype} btn-primary{x2;else} btn-default{x2;endif}" href="index.php?exam-app-point&pointid={x2;$point['pointid']}&questype={x2;v:questype}">{x2;$questypes[v:questype]['questype']}</a>
                    {x2;endif}
                </div>
                {x2;if:$question}
                ...
                <div id="answerbox" class="panel panel-default pagebox border hide" style="position: relative;">
                ...
                <div id="notebox" class="panel panel-default pagebox border hide" style="background: none;">
                    <div class="panel-heading bold" style="background: none;">
                        ...
                        <a class="btn btn-default" href="javascript:;" onclick="javascript:$('#askframe').slideToggle();"><i class="glyphicon glyphicon-question-sign"></i> 试题答疑</a>
                    </div>
            ...
            <div style="height: 100vh;position: fixed;top:0px;right:0px;width: 50%;background-color: #FFFFFF;box-shadow: rgba(0,0,0,0.6) 0px 0px 10px;display: none;" id="askframe">
                <div style="background-color:#f5f5f5;width:100%;box-shadow: rgba(0,0,0,0.1) 0px 0px 10px;position: absolute;right:0px;top:0px;z-index:99;line-height: 36px;">
                    <a style="display:block;width:36px;height:36px;padding:6px;font-size: 24px;" class="glyphicon glyphicon glyphicon-remove-circle pull-right" href="javascript:;" onclick="javascript:$('#askframe').slideToggle();"></a>
                    <h3 style="text-indent: 15px;">答疑</h3>
                    &nbsp;&nbsp;&nbsp;&nbsp;先看看其他同学的答疑是否解决了您的问题吧~
                </div>
                <iframe src="index.php?exam-app-point-faq&questionid={x2;$question['questionid']}" frameborder="0" width="100%" height="100%"></iframe>
            </div>
        </div>
    </div>
</div>
...
<script>
    function prepage(){
        {x2;if:$number > 1}
        window.location = 'index.php?exam-app-point&questype={x2;$questype}&pointid={x2;$point['pointid']}&number={x2;eval: echo $number - 1}';
        {x2;endif}
    }
    ...
    $(function () {
        ...
        {x2;endif}
        $('.selectbox :radio').on('change',function(){
            $(this).parent().find('.selector').trigger('click');
        });
