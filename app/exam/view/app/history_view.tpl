			...
			<div class="col-xs-9 nopadding" id="exampaper" style="position: relative">
				...
				<div class="questionpanel" data-questionid="{x2;v:question['questionid']}">
					...
					<div class="panel panel-default pagebox border" style="position: relative;background: none;">
						...
						<div class="panel-heading bold" style="font-weight: 800;background: none;">
							我的答案：<span class="text-warning myanswer">{x2;if:$history['ehuseranswer'][v:question['questionid']]}
							{x2;if:is_array($history['ehuseranswer'][v:question['questionid']])}
							{x2;eval: echo implode('',$history['ehuseranswer'][v:question['questionid']])}
							{x2;else}
							{x2;realhtml:$history['ehuseranswer'][v:question['questionid']]}
							{x2;endif}
							{x2;else}未做答{x2;endif}</span>
						</div>
						<div class="panel-heading bold" style="font-weight: 800;background: none;">
