...
<div class="pages">
    {x2;endif}
							...
							<div class="page-ele margin mg1 nomgLR">
								<div class="question form-group">
									<div class="form-inline text-center">
										评分：<input needle="needle" msg="请输入评分" size="4" class="form-control hasborder" name="score[{x2;v:question['questionid']}]" value="" />（满分{x2;$history['ehsetting']['papersetting']['questype'][v:questype]['score']}分）
									</div>
								</div>
							</div>
						</div>
		...
		<script>
            $(function() {
                pep.mask.show('warning',{message:'左右滑动页面切换试题评分'});
