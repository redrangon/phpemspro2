				...
				<div class="page-ele contin">
					<ul class="listmenu">
						<li class="small display dflex">
							<a class="ajax" href="index.php?exam-mobile-exam-selectquestions&paperid={x2;v:paper['paperid']}">
								<div class="col-xs-9 cflex">
									<div class="title">{x2;substring:$examsession['esdata']['name'],63}</div>
									<div class="intro">
										总分：{x2;$examsession['esdata']['setting']['papersetting']['score']}分 时间：{x2;$examsession['esdata']['setting']['papersetting']['papertime']}分钟
									</div>
								</div>
								<div class="col-xs-3 text-center cflex bg">
									<span class="ccmiddle" style="width: 100%;">继续考试</span>
								</div>
							</a>
						</li>
						<li style="padding:0.05rem 0.15rem">
							<div class="clear">
								<a href="index.php?exam-mobile-exam-cancel" class="confirm btn btn-danger btn-block" message="确定要放弃吗？" style="color: #FFFFFF;">放弃续考</a>
							</div>
						</li>
					</ul>
				</div>
