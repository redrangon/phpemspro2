...
<div class="clear question">
    <div class="text-center">
        ...
        <label class="selectbox checkbox">
            ...
            <span class="selector fa fa-check"></span>
...
<div class="clear question selectdiv">
    {x2;$question['questionselect']}
</div>
<div class="clear question text-center">
    {x2;tree:$setting['selectortype'],selector,sid}
...
<div class="clear question">
    ...
    {x2;else}
    {x2;eval:$question['questionselect'] = is_array($question['questionselect'])?$question['questionselect']:\\PHPEMSPRO\\strings::parseSelector($question['questionselect'])}
    ...
    <div class="text-center">
        <hr/>
        <a class="btn btn-primary finishbtn" rel="{x2;$question['questionid']}">回答完毕</a>
    </div>
    {x2;endif}
</div>
{x2;endif}