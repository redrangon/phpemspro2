        ...
        <div class="pages-content nofooter">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="pages-box swiper-slide">
                        <div class="page-ele margin mg1 nomgLR">
                            <h5 class="bigtitle col-xs-12">题干</h5>
                            <div class="clear question">
                                {x2;$questionrows['qrquestion']}
                            </div>
                        </div>
                        <div class="page-ele margin mg1 nomgLR">
                            <h5 class="bigtitle col-xs-12">第{x2;v:qid}题 {x2;$questypes[$question['questiontype']]['questype']}</h5>
                            <div class="clear question">
