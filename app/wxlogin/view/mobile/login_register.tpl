    ...
    <div class="pages-tabs">
        ...
        <div class="pages-content nofooter">
            <div class="pages-box">
                ...
                <div class="page-form">
                    <form method="post" action="index.php?wxlogin-mobile-index-bindregister">
                        <div class="form-group border">
                            <label class="control-label col-xs-3">用户名</label>
                            <div class="col-xs-9">
                                <input type="text" class="" name="args[username]" needle="needle" datatype="userName" msg="您必须填写用户名" placeholder="请输入用户名"/>
                            </div>
                        </div>
                        <div class="form-group border">
                            <label class="control-label col-xs-3">邮箱</label>
                            <div class="col-xs-9">
                                <input type="text" class="" name="args[useremail]" needle="needle" datatype="email" msg="您必须填写邮箱" placeholder="请输入邮箱"/>
                            </div>
                        </div>
                        <div class="form-group border">
                            <label class="control-label col-xs-3">手机号码</label>
                            <div class="col-xs-9">
                                <input type="text" class="" id="regphonenumber" name="args[userphone]" needle="needle" datatype="phonenumber" msg="您必须填写手机号" placeholder="请输入手机号"/>
                            </div>
                        </div>
                        <div class="form-group border">
                            <label class="control-label col-xs-3">验证码</label>
                            <div class="col-xs-5">
                                <input type="password" class="" name="randcode" needle="needle" datatype="number" msg="您必须填写验证码" placeholder="请输入验证码"/>
                            </div>
                        ...
                        <div class="form-group border">
                            ...
                            <div class="col-xs-9">
                                <input type="password" class="" name="args[userpassword]" needle="needle" datatype="password" msg="您必须填写登陆密码" placeholder="请输入登陆密码"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="text-center">
                                已注册帐号？
                                <a href="index.php?wxlogin-mobile-login" class="ajax" data-title="用户登录" data-page="yes">立即登录</a>
