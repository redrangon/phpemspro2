    ...
    <div class="pages-tabs">
        ...
        <div class="pages-content nofooter">
            <div class="pages-box">
                ...
                <div class="page-form">
                    <form method="post" action="index.php?wxlogin-mobile-index-bindlogin">
                        <div class="form-group border">
                            <label class="control-label col-xs-3">用户名</label>
                            <div class="col-xs-9">
                                <input type="text" class="" name="args[username]" needle="needle" datatype="userName" msg="请输入登陆用户名" placeholder="请输入登陆用户名"/>
                            </div>
                        </div>
                        <div class="form-group border">
                            <label class="control-label col-xs-3">密码</label>
                            <div class="col-xs-9">
                                <input type="password" class="" name="args[userpassword]" needle="needle" datatype="password" msg="请输入登陆密码" placeholder="请输入登陆密码"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="controls">
                                <button class="btn btn-primary btn-block" type="submit">登录并绑定微信</button>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="text-center">
                                还没有注册帐号？
                                <a href="index.php?wxlogin-mobile-index-bindregister" class="ajax" data-title="用户注册" data-page="yes">立即注册</a>
