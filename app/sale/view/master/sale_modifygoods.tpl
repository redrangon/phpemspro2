			...
			<div id="datacontent">
				...
				<div class="panel panel-default" id="datacontent-container">
					...
					<div class="panel-body">
						<form action="index.php?{x2;$_route['app']}-master-sales-modifygoods" method="post" class="form-horizontal">
							<fieldset>
											...
											<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
												<div class="qq-upload-button-selector" style="clear:both;">
													...
													<ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
														<li class="text-center">
															<div class="thumbnail">
																<img class="qq-thumbnail-selector" src="{x2;if:$goods['sgdthumb']}{x2;$goods['sgdthumb']}{x2;else}public/static/images/noimage.gif{x2;endif}" alt="点击上传新图片">
																<input type="hidden" class="qq-edit-filename-selector" name="args[sgdthumb]" tabindex="0" value="{x2;if:$goods['sgdthumb']}{x2;$goods['sgdthumb']}{x2;else}public/static/images/noimage.gif{x2;endif}">
															</div>
														</li>
													</ul>
												</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="hidden" name="modifygoods" value="1"/>
