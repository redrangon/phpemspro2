			...
			<div id="datacontent">
				...
				<div class="panel panel-default" id="datacontent-container">
					...
					<div class="panel-body">
						<form action="index.php?{x2;$_route['app']}-master-sales-modify" method="post" class="form-horizontal">
							<fieldset>
											...
											<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
												<div class="qq-upload-button-selector" style="clear:both;">
													...
													<ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
														<li class="text-center">
															<div class="thumbnail">
																<img class="qq-thumbnail-selector" src="{x2;if:$sale['salethumb']}{x2;$sale['salethumb']}{x2;else}public/static/images/noimage.gif{x2;endif}" alt="点击上传新图片">
																<input type="hidden" class="qq-edit-filename-selector" name="args[salethumb]" tabindex="0" value="{x2;if:$sale['salethumb']}{x2;$sale['salethumb']}{x2;else}public/static/images/noimage.gif{x2;endif}">
															</div>
														</li>
													</ul>
												</div>
								...
								<div class="form-group">
									...
									<div  class="col-sm-10 form-inline">
										<input class="form-control datetimepicker" data-minview="0" data-date-format="yyyy-mm-dd hh:ii:ss" name="args[salestime]" value="{x2;$sale['salestime']}" type="text" msg="您必须输入一个开启时间起点" /> - <input class="form-control datetimepicker" data-minview="0" data-date-format="yyyy-mm-dd hh:ii:ss" name="args[saleetime]" value="{x2;$sale['saleetime']}" type="text" msg="您必须输入一个开启时间终点" />
									</div>
								</div>
								<div class="form-group">
									<label for="catdes" class="control-label col-sm-2">活动信息</label>
									<div  class="col-sm-10">
										<textarea class="form-control" rows="5" name="args[saleinfo]">{x2;$sale['saleinfo']}</textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="hidden" name="modifysale" value="1"/>
