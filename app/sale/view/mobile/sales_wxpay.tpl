        ...
        <div class="pages-content nofooter" data-refresh="yes">
            <div class="pages-box">
                ...
                <div class="page-ele clear">
                    <p class="col-xs-12">
                        <a class="btn btn-primary btn-block ajax" onclick="javascript:callpay();">微信支付</a>
                    </p>
                </div>
                {x2;elseif:$order['orderstatus'] == 2}
                <div class="page-ele clear">
                    <p class="col-xs-12">
                        <a class="btn btn-success btn-block ajax">已完成</a>
                    </p>
                </div>
                {x2;else}
                <div class="page-ele clear">
                    <p class="col-xs-12">
                        <a class="btn btn-default btn-block ajax">已取消</a>
                    </p>
                </div>
                {x2;endif}
            </div>
