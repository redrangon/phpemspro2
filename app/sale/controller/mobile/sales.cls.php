        ...
        if($paytype == 'wxpay')
        {
            if(route::isMobile())
            {
                if (route::isWeixin())
                {
                    $message = array(
                        ...
                        "forwardUrl" => 'index.php?sale-mobile-sales-wxpay&ordersn='.$args['ordersn']
                    );
                    route::urlJump($message);
                }
                else
            ...
            else
            {
                $message = array(
                    ...
                    "message" => "下单成功！",
                    "callbackType" => "forward",
                    "forwardUrl" => 'index.php?sale-app-sales-wxpay&ordersn='.$args['ordersn']
                );
                route::urlJump($message);
            }
        }
