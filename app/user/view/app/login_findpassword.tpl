...
<script>
	...
	$('#randsendbtn').click(function(){			
        ...
        if(sendstatus)
        {
			$.getJSON('index.php?core-api-index-sendsms&action=findpassword&randcode='+$('#randformcode').val()+'&phonenumber='+$('#regphonenumber').val()+'&userhash='+Math.random(),function(data){
