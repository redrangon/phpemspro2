<div class="leftmenu">
    ...
    <ul class="list-unstyled">
        ...
        <a href="index.php?user-app-verify">
            <li{x2;if:$_route['method'] == 'verify'} class="active"{x2;endif}>
                <i class="glyphicon glyphicon-camera"></i>
                实名认证
                <i class="glyphicon glyphicon-menu-right pull-right"></i>
            </li>
        </a>
        <a href="index.php?user-app-msg">
            <li{x2;if:$_route['method'] == 'msg'} class="active"{x2;endif}>
                <i class="glyphicon glyphicon-envelope"></i>
                站内信 <span class="badge autoloaditem" autoload="index.php?user-app-msg-getnewmsgnumber">0</span>
                <i class="glyphicon glyphicon-menu-right pull-right"></i>
            </li>
        </a>
        ...
        {x2;elseif:$_user['usergroupcode'] == 'agent'}
        <a href="index.php?finance-agent">
            <li>
                <i class="glyphicon glyphicon-cog"></i>
                后台管理
                <i class="glyphicon glyphicon-menu-right pull-right"></i>
