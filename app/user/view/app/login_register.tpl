						...
						<div class="form-group" style="overflow:hidden;margin-bottom: 0px;">
							<div class="col-sm-9" style="padding-left:0px;">
								<div class="input-group">
									...
									<input class="form-control" type="text" maxlength="4" placeholder="请输入手机验证码" name="randcode" style="width:92%;"/>
								</div>
							</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="randform">
					<div class="form-group">
						<div class="col-sm-3"></div>		
						<div class="col-sm-4">
							<input class="form-control" id="randformcode" type="text" needle="needle" msg="请输入验证码">
						</div>
						<div class="col-sm-2"><img src="index.php?core-api-index-randcode" class="randCode"/></div>		
						<div class="col-sm-3"></div>		
					</div>
				</form>
			</div>
			<div class="modal-footer">
				<button class="btn btn-primary" id="randsendbtn">发送短信</button>
			</div>
		</div>
	</div>
</div>
