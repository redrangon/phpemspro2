                ...
                <div class="page-form">
                    <form method="post" action="index.php?user-mobile-login-findpassword">
                        <div class="form-group border">
                            ...
                            <div class="col-xs-9">
                                <input type="text" class="" id="findphonenumber" name="args[userphone]" needle="needle" datatype="phonenumber" msg="您必须填写手机号" placeholder="请输入手机号" autocomplete="off"/>
                            </div>
                        </div>
                        <div class="form-group border">
                        ...
                        <div class="form-group border">
                            ...
                            <div class="col-xs-9">
                                <input type="password" class="" id="setfindpassword" name="args[userpassword]" needle="needle" datatype="password" msg="您必须填写登陆密码" placeholder="请输入登陆密码" autocomplete="off"/>
                            </div>
                        </div>
                        <div class="form-group border">
                            <label class="control-label col-xs-3">重复密码</label>
                            <div class="col-xs-9">
                                <input type="password" class="" equ="setfindpassword" name="args[reuserpassword]" needle="needle" datatype="password" msg="您必须填写登陆密码" placeholder="请输入登陆密码" autocomplete="off"/>
                            </div>
                        </div>
        ...
        $('#sendfindphonecode').click(function(){
            ...
            if(pep.sendstatus)
            {
				pep.mask.show('randcode',{},function(){
					$.getJSON('index.php?core-api-index-sendsms&action=findpassword&randcode='+$('#randformcode').val()+'&phonenumber='+$('#findphonenumber').val()+'&userhash='+Math.random(),function(data){
