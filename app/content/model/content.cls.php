...
namespace PHPEMSPRO\content\model;
...
class content
{
    ...
    static public function getContentList($args,$page,$number = \PHPEMSPRO\config::webpagenumber,$orderby = 'contentorder desc,contentid desc')
    {
        $data = array(
            'table' => 'contents',
            'query' => $args,
