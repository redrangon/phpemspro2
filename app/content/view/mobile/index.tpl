    ...
    <div class="pages-tabs">
        ...
        <div class="pages-content">
            ...
            <div class="pages-box nopadding">
                ...
                {x2;endif}
                <div class="page-ele contin">
                    <a data-page="yes" data-title="考试公告" href="index.php?content-mobile-category&catid=3" class="ajax">
                        <p class="text-center">更多</p>
                    </a>
                </div>
            </div>
        ...
        <div class="pages-footer">
            <a class="col-xs-3 active menu"><div class="text-center">
                    <span class="fa fa-record"></span><br />发现
                </div></a>
            <a class="col-xs-3 menu"><div class="text-center">
                    <span class="fa fa-play-circle"></span><br />课程
                </div></a>
            <a class="col-xs-3 menu"><div class="text-center">
                    <span class="fa fa fa-edit"></span><br />题库
                </div></a>
            <a class="col-xs-3 menu"><div class="text-center">
                    <span class="fa fa-education"></span><br />我的
                </div></a>
        </div>
    </div>
    <div class="pages-tabs">
                        ...
                        <a href="index.php?lesson-mobile-category&catid={x2;v:cat['catid']}" class="ajax" data-page="yes" data-title="{x2;v:cat['catname']}">
                            <div class="cards">
                                <div class="col-xs-4" style="padding-top: 0.15rem;">
                                    <img src="{x2;v:cat['catthumb']}" class="img-circle" style="width: 100%;"/>
                                </div>
                                <div class="col-xs-8">
                                    <h5 class="title">{x2;v:cat['catname']}</h5>
                                    <p>
                                        {x2;realsubstring:v:cat['catintro'],48}
                                    </p>
                                </div>
                            </div>
                        </a>
        ...
        <div class="pages-content">
            <div class="pages-box nopadding">
                ...
                <div class="page-ele margin">
                    ...
                    <div class="col-xs-3" style="padding: 0.1rem;">
                        <img class="img-circle" src="public/static/images/icon.jpg" style="width: 100%;"/>
                    </div>
                    <div class="col-xs-5" style="padding-top: 0.15rem;">
                        <h5 class="title">{x2;if:$_user['userrealname']}{x2;$_user['userrealname']}{x2;else}未设置{x2;endif}</h5>
                        <p>
                ...
                <div class="page-ele margin">
                    ...
                    <div class="col-xs-4 text-center" style="padding: 0.1rem;">
                ...
                <div class="page-ele">
                    <ul class="listmenu">
                        <li><a href="index.php?user-mobile-coupon" class="ajax"><i class="fa fa-flash"></i> 激活码激活 <i class="fa fa-menu-right pull-right"></i></a></li>
                        <li><a href="index.php?lesson-mobile" class="ajax" data-page="yes" data-title="我的课程"><i class="fa fa-play-circle"></i> 我的课程 <i class="fa fa-menu-right pull-right"></i></a></li>
                        <li><a href="index.php?exam-mobile" class="ajax" data-page="yes" data-title="我的题库"><i class="fa fa-edit"></i> 我的考场 <i class="fa fa-menu-right pull-right"></i></a></li>
                        <li><a href="index.php?user-mobile-msg" class="ajax"><i class="fa fa-envelope"></i> 站内信{x2;if:$_user['userid']} <span class="badge autoloaditem" autoload="index.php?user-mobile-msg-getnewmsgnumber">0</span>{x2;endif} <i class="fa fa-menu-right pull-right"></i></a></li>
                        <li><a href="index.php?user-mobile-orders" class="ajax"><i class="fa fa-credit-card"></i> 我的订单 <i class="fa fa-menu-right pull-right"></i></a></li>
                        <li><a href="index.php?user-mobile-user-info" class="ajax"><i class="fa fa-user"></i> 个人信息 <i class="fa fa-menu-right pull-right"></i></a></li>
                        <li><a href="index.php?finance-mobile" class="ajax"><i class="fa fa-yen"></i> 代理平台 <i class="fa fa-menu-right pull-right"></i></a></li>
                        <li><a href="index.php?user-mobile-user-password" class="ajax"><i class="fa fa-cog"></i> 修改密码 <i class="fa fa-menu-right pull-right"></i></a></li>
                    </ul>
                </div>
                <div class="page-ele hide">
                    <ul class="listmenu">
                        <li><a href="">推荐给好友 <span class="text-danger" style="font-size: 0.14rem;margin-left: 0.24rem;">邀请可得5元优惠券</span><i class="fa fa-menu-right pull-right"></i></a></li>
                    </ul>
                </div>
                {x2;if:$_user['userid']}
                <div class="page-ele clear">
