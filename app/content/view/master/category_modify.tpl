...
{x2;endif}
				...
				<div class="panel panel-default" id="datacontent-container">
					...
					<div class="panel-body">
						<form action="index.php?content-master-category-modify" method="post" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									<label class="control-label col-sm-2">列表展示：</label>
									<div class="col-sm-9">
										<label class="radio-inline">
											<input type="radio" name="args[catstatus]" value="0"{x2;if:!$category['catstatus']} checked{x2;endif}/> 显示
										</label>
										<label class="radio-inline">
											<input type="radio" name="args[catstatus]" value="1"{x2;if:$category['catstatus']} checked{x2;endif}/> 隐藏
										</label>
									</div>
								</div>
								<div class="form-group">
											...
											<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
												<div class="qq-upload-button-selector" style="clear:both;">
													...
													<ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
														<li class="text-center">
															<div class="thumbnail">
																<img class="qq-thumbnail-selector" src="{x2;if:$category['catthumb']}{x2;$category['catthumb']}{x2;else}public/static/images/noimage.gif{x2;endif}" alt="点击上传新图片">
																<input type="hidden" class="qq-edit-filename-selector" name="args[catthumb]" tabindex="0" value="{x2;if:$category['catthumb']}{x2;$category['catthumb']}{x2;else}public/static/images/noimage.gif{x2;endif}">
															</div>
														</li>
													</ul>
												</div>
								...
								<div class="form-group">
									...
									<div  class="col-sm-10">
										<textarea class="ckeditor" rows="7" id="catdes" name="args[catintro]">{x2;$category['catintro']}</textarea>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="hidden" name="modifycategory" value="1">
										<input type="hidden" name="catid" value="{x2;$category['catid']}">
