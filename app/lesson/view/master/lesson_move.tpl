			...
			<div id="datacontent">
				...
				<div class="panel panel-default" id="datacontent-container">
					...
					<div class="panel-body">
						<form action="index.php?lesson-master-lessons-movecategory" method="post" class="form-horizontal">
							<div class="form-group">
								<label class="control-label col-sm-2">课程ID</label>
								<div class="col-sm-4">
									<input class="form-control" type="text" name="lessonids" value="{x2;$lessonids}" needle="needle" msg="您必须输入标题" readonly>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-2">目标分类</label>
								<div class="col-sm-8 form-inline">
									<select msg="您必须选择一个目标分类" needle="needle" class="autocombox form-control" name="targetcatid" refUrl="index.php?lesson-master-ajax-getchildcategory&catid={value}">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<a class="btn btn-primary" href="index.php?lesson-master-lessons&page={x2;$page}{x2;$u}">取消</a>
