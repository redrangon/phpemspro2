...
{x2;endif}
				<ol class="breadcrumb">
					...
					<li><a href="index.php?{x2;$_route['app']}-master-lessons&catid={x2;$catid}&page={x2;$page}">课程管理</a></li>
				...
				<div class="panel panel-default" id="datacontent-container">
					...
					<div class="panel-body">
						<form action="index.php?lesson-master-lessons-add" method="post" class="form-horizontal">
							<div class="form-group">
								<label class="control-label col-sm-2">分类：</label>
								<div class="col-sm-9">
									<select name="args[lessoncatid]" refUrl="index.php?lesson-master-ajax-getchildcategory&catid={value}" class="autocombox form-control col-xs-3" style="width:20%" needle="needle" msg="请选择分类" id="lessoncatid">
										<option value='' selected>请选择分类</option>
										{x2;tree:$parentcat,cat,catid}
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input class="form-control" id="lessonname"  type="text" name="args[lessonname]" />
								</div>
							</div>
							<div class="form-group">
								<label for="lessontime" class="control-label col-sm-2">时间：</label>
								<div class="col-sm-9">
									<input class="form-control datetimepicker normalinput" data-date-format="yyyy-mm-dd hh:ii:ss" id="lessontime"  type="text" name="args[lessontime]" />
								</div>
							</div>
							<div class="form-group">
										...
										<div class="qq-uploader-selector" style="width:30%">
											<div class="qq-upload-button-selector" style="clear:both;">
												...
												<ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
													<li class="text-center">
														<div class="thumbnail">
															<img src="app/core/styles/img/noimage.gif" alt="点击上传新图片" class="qq-thumbnail-selector">
															<input type="hidden" class="qq-edit-filename-selector" name="args[lessonthumb]" value="app/core/styles/img/noimage.gif">
														</div>
													</li>
												</ul>
											</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<input type="hidden" name="addlesson" value="1">
								</div>
							</div>
						</form>
					</div>
