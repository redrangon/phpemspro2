...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					...
					<form action="index.php?lesson-master-contents-lite" method="post" class="form-horizontal">
				        ...
				        <div class="form-group">
		        			...
		        			<div class="col-sm-4">
			        			<select class="form-control" msg="您必须选择一个目标分类" needle="needle" class="autocombox input-medium" name="targetcatid" refUrl="index.php?lesson-master-category-ajax-getchildcategory&catid={value}">
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
					            ...
					            <a class="btn btn-primary" href="index.php?lesson-master-contents&page={x2;$page}{x2;$u}">取消</a>
