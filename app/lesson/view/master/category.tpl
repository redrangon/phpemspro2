...
{x2;endif}
				...
				<div class="panel panel-default" id="datacontent-container">
					<div class="panel-heading">
						...
						<a href="index.php?lesson-master-category-add&parent={x2;$parent}" class="pull-right">增加</a>
					</div>
					<div class="panel-body">
						<form action="index.php?lesson-master-category-order" method="post">
							<fieldset>
										...
										<tr>
											...
											<td>
												<ul class="list-inline list-unstyled">
													<li><a href="index.php?lesson-master-category&parent={x2;v:category['catid']}{x2;$u}">子分类</a></li>
													<li><a href="index.php?lesson-master-category-modify&catid={x2;v:category['catid']}{x2;$u}">修改</a></li>
													<li><a class="confirm" href="index.php?lesson-master-category-del&catid={x2;v:category['catid']}&page={x2;$page}{x2;$u}">删除</a></li>
												<ul/>
											</td>
										</tr>
										{x2;endtree}
